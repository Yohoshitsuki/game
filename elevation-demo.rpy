label elevation_demo:
    ...
    python:
        ...
        battle = Battle(CustomSchema(SimpleTurnSchema, attackResolver=MyOtherAttackResolver, uiProvider=TileUIProvider(highlight="gfx/iso-select.png")))
        ...
        fieldSprite = ElevationGridSprite(Image('gfx/tile-bg.jpg'), demoTileMap, origin=(362, 441), spaceSize=(50, -25), heightStep=0)
        
        # We can then set the GridBattlefield up with similar values, and get the gridSize values from the TileMap.
        battle.SetBattlefield(GridBattlefield(fieldSprite, map=demoTileMap, origin=(362, 441), gridSize=(demoTileMap.XSize, demoTileMap.YSize), spaceSize=(50, -25), diagonals=False, heightStep=0, isometric=True))
