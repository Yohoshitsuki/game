label party_screen_demo:
    ...
    python:
        ...
        a = PlayerFighter("Simon", portrait="gfx/Saber.png", Speed=10, Move=5, Attack=15, Defence=3, Health=10)
        b = PlayerFighter("Cybil", portrait="gfx/Saber.png", Speed=11, Move=5, Attack=14, Defence=3, Health=10)
