...
init:
    ...
    image bob portrait = 'gfx/Saber.png'
...
init python:
    ...
    Library.Equipment.LeatherArmour = Armour("Leather Armour", defence=5, Bonus_Move=1, cost=15)
    ...
    Library.Skills.SwordAttack = AttackSkill(command=[('Attack', -1)], attributes=['Attack', 'Angry'], multiplier=1.2, sfx="audio/sword.wav")
    Library.Skills.FeelAttack = AttackSkill(command=[('Feel', -2)], attributes=['Feel', 'Angry'], multiplier=1.2, sfx="audio/sword.wav")
    Library.Skills.KnifeAttack = AttackSkill(command=[('Attack', -1)], attributes=['Attack', 'Angry'],multiplier=1.0, sfx="audio/knife.wav", name="Knife")
    Library.Skills.ClawAttack = AttackSkill(command=[('Attack', -1)], attributes=['Attack', 'Angry'], multiplier=1, sfx="audio/sword.wav", name="Slash")
    ...
    #---Agressive---#
    Library.Skills.ClumsyAttack = AttackSkill(command=[('Attack', -1)], attributes=['Attack', 'Heavy'], multiplier=0.8, hitt=80, sfx="audio/sword.wav")
    Library.Skills.NormalAttack = AttackSkill(command=[('Attack', -2)], attributes=['Attack', 'Heavy'], multiplier=1.0, hitt=100, sfx="audio/sword.wav")
    
    #--Friendly-----#
    Library.Skills.ClumsyHug = FriendlyAttackSkill(command=[('ClumsyHug', -1)], attributes=['Attack', 'Friendly', 'Charm', 'Light'], multiplier=0.8, hitt=80, sfx="audio/sword.wav")
    Library.Skills.NormalHug = FriendlyAttackSkill(command=[('NormalHug', -2)], attributes=['Attack', 'Friendly', 'Charm', 'Light'], multiplier=1.0, hitt=100, sfx="audio/sword.wav")
    
    Library.Skills.TryCharm = FriendlyAttackSkill(command=[('Try to Charm', -1)], attributes=['Speech', 'Friendly', 'Charm', 'Light'], multiplier=0.8, hitt=80, sfx="audio/sword.wav")
    Library.Skills.Charm = FriendlyAttackSkill(command=[('Charm', -2)], attributes=['Speech', 'Friendly', 'Charm', 'Light'], multiplier=1.0, hitt=100, sfx="audio/sword.wav")
    
    Library.Skills.TryExcite = FriendlyAttackSkill(command=[('Try to Excite', -1)], attributes=['Speech', 'Friendly', 'Excite','Light'], multiplier=0.8, hitt=80, sfx="audio/sword.wav")
    Library.Skills.Excite = FriendlyAttackSkill(command=[('Excite', -2)], attributes=['Speech', 'Friendly', 'Excite', 'Light'], multiplier=1.0, hitt=100, sfx="audio/sword.wav")
    
    #--Dievius---#
    Library.Skills.TrySad = MagicFighterAttackSkill("Try to Saden", command=[("Try to Saden", 7)], attributes=['Speech', 'Sad', 'Devius', 'Heavy'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.Sad = MagicFighterAttackSkill("Sad", command=[("Saden", 8)], attributes=['Speech', 'Sad', 'Devius', 'Heavy'], damage=0, hitt=100, multiplier=1.0, cost=8, range=1, sprite=BattleSprite('earth 2', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth2.wav")
    
    Library.Skills.TryAnger = MagicFighterAttackSkill("Try to Anger", command=[("Ty to Anger", 7)], attributes=['Speech', 'Anger', 'Devius', 'Heavy'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.Anger = MagicFighterAttackSkill("Anger", command=[("Anger", 8)], attributes=['Speech', 'Anger', 'Devius', 'Heavy'], damage=0, hitt=80, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 2', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth2.wav")
    
    Library.Skills.TryTerrify = MagicFighterAttackSkill("Try to Terrify", command=[("Ty to Terrify", 7)], attributes=['Speech', 'Terrify', 'Devius', 'Heavy'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.Terrify = MagicFighterAttackSkill("Terrify", command=[("Terrify", 8)], attributes=['Speech', 'Terrify', 'Devius', 'Heavy'], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 2', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth2.wav")
    
    #---Reson----#
    Library.Skills.TryConfuse = MagicFighterAttackSkill("Try to Confuse", command=[("Try to Confuse", 7)], attributes=['Speech', 'Confuse', 'Reson', 'Light'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.Confuse = MagicFighterAttackSkill("Confuse", command=[("Confuse", 8)], attributes=['Speech', 'Confuse', 'Reson', 'Light'], damage=0, hitt=100, multiplier=1.0, cost=8, range=1, sprite=BattleSprite('earth 2', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth2.wav")
    Library.Skills.TryCurious = MagicFighterAttackSkill("Try to Curious", command=[("Ty to Curious", 7)], attributes=['Speech', 'Curious', 'Reson', 'Light'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.Curious = MagicFighterAttackSkill("Curious", command=[("Curious", 8)], attributes=['Speech', 'Curious', 'Reson', 'Light'], damage=0, hitt=80, multiplier=0.8, cost=0, range=1, sprite=BattleSprite('earth 2', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth2.wav")
    
    
    #-------Responses-------#
    
    Library.Skills.BeSad = MagicFighterAttackSkill("Be Sad", command=[("Emotion", 1), ("Be Sad", 7)], attributes=['Speech', 'Sad', 'Devius', 'Heavy', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.BeAngry = MagicFighterAttackSkill("Be Angry", command=[("Emotion",1), ("Be Angry", 7)], attributes=['Speech', 'Angry', 'Devius', 'Heavy', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=2, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.BeTerrified = MagicFighterAttackSkill("Be Terrified", command=[("Emotion", 5), ("Be Terrified", 7)], attributes=['Speech', 'Terrified', 'Devius', 'Heavy', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    
    Library.Skills.BeCharmed = MagicFighterAttackSkill("Be Charmed", command=[("Emotion", 1), ("Be Charmed", 7)], attributes=['Speech', 'Charmed', 'Friendly', 'Light', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.BeExited = MagicFighterAttackSkill("Be Exited ", command=[("Emotion", 1), ("Be Exited", 7)], attributes=['Speech', 'Exited', 'Friendly', 'Light', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    
    Library.Skills.BeConfused = MagicFighterAttackSkill("Be Confused", command=[("Emotion", 1), ("Be Confused", 7)], attributes=['Speech', 'Confused', 'Reson', 'Light', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    Library.Skills.BeCurious = MagicFighterAttackSkill("Be Curious", command=[("Emotion", 1), ("Be Curious", 7)], attributes=['Speech', 'Curious', 'Reson', 'Light', 'Emotion' ], damage=0, hitt=100, multiplier=1.0, cost=0, range=1, sprite=BattleSprite('earth 1', anchor=(0.5, 0.8)), pause=0.6, sfx="audio/earth.wav")
    ...
    style.PickTargetPositionButton.background="gfx/select64x64.png"
    style.PickTargetPositionButton.hover_background ="gfx/attack_select64x64.png"
